...
export const DealLockOverlay = forwardRef<HTMLDivElement, DealLockOverlayProps>(
  ({ options, maxAmount, onConfirm, onCancel }, ref) => {
    return (
      <motion.div
        ref={ref}
        initial={{ opacity: 0 }}
...
DealLockOverlay.displayName = 'DealLockOverlay';
