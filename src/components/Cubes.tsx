...
const Cubes: React.FC<CubesProps> = ({
    ...
    useEffect(() => {
        ...
        return () => {
            ...
            el.removeEventListener('click', onClick as unknown as EventListener);
    ...
    return (
        <div className="relative w-full h-full overflow-hidden flex items-center justify-center opacity-70" style={wrapperStyle}>
